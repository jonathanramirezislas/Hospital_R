...
# |------------------------------------------------------------------------------------------|
Init <- function(fileStr, workDirStr = "C:/Users/jonaathan/Desktop/Repositorio/Hospital_R") {
    setwd(workDirStr)
...
rankall <- function(outcomeChr, rankObj = "best") {
    ...
    outcomeDfr <- Init("C:/Users/jonaathan/Desktop/Repositorio/Hospital_R/outcome-of-care-measures.csv")
